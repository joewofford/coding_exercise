...
def est_ticker(account, venue, ticker, qty, conn_in, conn_out):
    url = "wss://api.stockfighter.io/ob/api/ws/FJT68020032/venues/XXEUEX/tickertape/stocks/IDYN"
    current_qty = 0
...
if __name__ == '__main__':
    ...
    t_test = Process(target=est_ticker, args=('FJT68020032', 'XXEUEX', 'IDYN', 50, c_conn_p_t, p_conn_t_p))
